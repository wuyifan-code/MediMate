...
export const Settings: React.FC<SettingsProps> = ({ currentLang, setLang, onBack }) => {
  ...
  return (
    <div className="pb-24">
      {/* Header */}
      <div className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-slate-100 px-4 h-[53px] flex items-center gap-6 cursor-pointer pt-safe" onClick={onBack}>
